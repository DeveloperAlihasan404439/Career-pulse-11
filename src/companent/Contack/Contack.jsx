  ...
  return (
    <div className="w-11/12 mx-auto md:flex gap-5 justify-between flex-row-reverse mb-20">
      <div className="md:w-[50%]">
        <h1 className="text-xl md:text-2xl text-black py-4 text-center md:text-left">
        ...
        <div className="py-2 md:py-5">
          <div className="flex gap-5 text-2xl font-medium p-2 border-l-2 border-b-2 border-r-2 border-orange-500 mb-5 rounded-lg shadow-xl">
            <img
